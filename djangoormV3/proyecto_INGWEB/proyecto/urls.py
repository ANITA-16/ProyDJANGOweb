...
urlpatterns = [
    ...
    path('buscar/', views.base, name='buscar_muebles'),   #Ruta para el buscador # Debe coincidir con fetch en JS
    path('toggle-like/<int:mueble_id>/', views.toggle_like, name='toggle_like'),
    #path('like/<int:mueble_id>/', views.darLike, name='dar_like'),
]
